...
- <b>Replacing Traditional Identification Cards With NFTs</b>
   - An short article suggesting the possible usage of blockchain technologies such as NFT's to replace traditional identification methods (presented in a logical in thoughfull way)
